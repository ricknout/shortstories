...
public enum ScenarioType {
    ...
    UNKNOWN(R.color.colorPrimary, R.mipmap.ic_launcher_round, R.raw.notification, new long[] {0, 100, 100, 100}),
    NEUTRAL(R.color.colorAccent, R.mipmap.ic_launcher_round, R.raw.notification, new long[] {0, 100, 100, 100}),
    SURPRISE(R.color.colorPrimary, R.mipmap.ic_launcher_round, R.raw.notification, new long[] {0, 100, 100, 100}),
    MYSTERY(R.color.colorAccent, R.mipmap.ic_launcher_round, R.raw.notification, new long[] {0, 100, 100, 100}),
    DESPAIR(R.color.colorPrimary, R.mipmap.ic_launcher_round, R.raw.notification, new long[] {0, 100, 100, 100}),
    HOPE(R.color.colorAccent, R.mipmap.ic_launcher_round, R.raw.notification, new long[] {0, 100, 100, 100}),
    REVOLT(R.color.colorPrimary, R.mipmap.ic_launcher_round, R.raw.notification, new long[] {0, 100, 100, 100}),
    VICTORY(R.color.colorAccent, R.mipmap.ic_launcher_round, R.raw.notification, new long[] {0, 100, 100, 100}),
    PEACE(R.color.colorPrimary, R.mipmap.ic_launcher_round, R.raw.notification, new long[] {0, 100, 100, 100}),
    DANGER(R.color.colorAccent, R.mipmap.ic_launcher_round, R.raw.notification, new long[] {0, 100, 100, 100}),
    DEFEAT(R.color.colorPrimary, R.mipmap.ic_launcher_round, R.raw.notification, new long[] {0, 100, 100, 100});
