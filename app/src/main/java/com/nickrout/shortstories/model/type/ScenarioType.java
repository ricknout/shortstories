...
public enum ScenarioType {
    ...
    ACHIEVEMENT(R.color.amber_500, R.drawable.ic_trophy_black_24dp, R.raw.achievement, new long[] {0, 100, 100, 100}),
    CHALLENGE(R.color.yellow_600, R.drawable.ic_terrain_black_24dp, R.raw.challenge, new long[] {0, 100, 100, 100}),
    CONFLICT(R.color.red_500, R.drawable.ic_sword_cross_black_24dp, R.raw.conflict, new long[] {0, 100, 100, 100}),
    DIRECTION(R.color.brown_500, R.drawable.ic_split_black_24dp, R.raw.direction, new long[] {0, 100, 100, 100}),
    ENDING(R.color.black, R.drawable.ic_book_black_24dp, R.raw.ending, new long[] {0, 100, 100, 100}),
    GAME(R.color.blue_500, R.drawable.ic_dice_multiple_black_24dp, R.raw.game, new long[] {0, 100, 100, 100}),
    HAPPY(R.color.deep_purple_a200, R.drawable.ic_happy_black_24dp, R.raw.happy, new long[] {0, 100, 100, 100}),
    ITEM(R.color.indigo_500, R.drawable.ic_cube_outline_black_24dp, R.raw.item, new long[] {0, 100, 100, 100}),
    MEAL(R.color.deep_orange_500, R.drawable.ic_meal_black_24dp, R.raw.meal, new long[] {0, 100, 100, 100}),
    MEETING(R.color.orange_500, R.drawable.ic_people_black_24dp, R.raw.meeting, new long[] {0, 100, 100, 100}),
    ...
    OFFER(R.color.teal_500, R.drawable.ic_redeem_black_24dp, R.raw.offer, new long[] {0, 100, 100, 100}),
    PREPARATION(R.color.pink_500, R.drawable.ic_checklist_black_24dp, R.raw.preparation, new long[] {0, 100, 100, 100}),
    PROBLEM(R.color.light_green_500, R.drawable.ic_alert_black_24dp, R.raw.problem, new long[] {0, 100, 100, 100}),
    PUZZLE(R.color.purple_500, R.drawable.ic_puzzle_black_24dp, R.raw.puzzle, new long[] {0, 100, 100, 100}),
    REQUIREMENT(R.color.lime_500, R.drawable.ic_inbox_black_24dp, R.raw.requirement, new long[] {0, 100, 100, 100}),
    TRANSACTION(R.color.green_500, R.drawable.ic_local_atm_black_24dp, R.raw.transaction, new long[] {0, 100, 100, 100}),
    UNHAPPY(R.color.blue_800, R.drawable.ic_sad_black_24dp, R.raw.unhappy, new long[] {0, 100, 100, 100}),
    YES_NO(R.color.purple_700, R.drawable.ic_thumbs_up_down_black_24dp, R.raw.yes_no, new long[] {0, 100, 100, 100});
